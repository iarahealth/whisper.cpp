...
extern "C" {
    ...
    struct whisper_full_params {
        ...
        bool suppress_tokens; // suppress iara-specific tokens, such as punctuation and numerals
...
#define SUPPRESS_TOKENS_SIZE (sizeof(SUPPRESS_TOKENS) / sizeof(SUPPRESS_TOKENS[0]))
